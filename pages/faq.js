        ...
        <div className="content">
          ...
          <div>
            ...
            <p>
              ...
              those who contribute to EleutherAI do so in their free time and
              tend to prefer contributing to projects rather than debugging your
              problems. We recommend consulting the corresponding documentation
              before asking us for help. If you think you have found a bug,
              please consider opening an issue on{" "}
          ...
          <div>
            ...
            <p>
              <a href="https://blog.eleuther.ai/why-release-a-large-language-model/">
                ...
                models at length, and have come to the conclusion that we
          ...
          <div>
            ...
            <p>
              ...
              models, the compute is unavailable for the time we would need due
              to the pre-empting of instances. Even with a v3-2048, a model
              between 150 and 175 billion parameters would require months to
              train. CoreWeave provides us a path to train models at the scales
              we would like, but we need to utilize their GPUs for training
              instead of TPUs.
            </p>
            <p>
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                ...
                underperform monolithic (regular) models for the same number of
                parameters.
              </li>
              <li>
            ...
            <p>
              ...
              use case is an unsolved problem. If you have expertise in this
              area, drop us a line and we will be happy to hear you out.
            </p>
          </div>
          <div>
            <h3>
            ...
            <p>
              Our intention is not to perfectly replicate the architecture used
              by GPT-3 but to instead build models comparable to what OpenAI has
              ...
              suited to language modeling: Attention mechanisms that scale with
              linear complexity with respect to sequence length are often
          ...
          <div>
            ...
            <p>
              ...
              GPT-3 on your first-generation Macbook Air. 175 billion parameters
              at single-precision (binary32) take up 700 Gigabytes, and
              realistically the entire model needs to be loaded into memory for
              inference. It is unlikely that consumer hardware will be able to
              run anything of that scale for years to come, even on CPU. To run
              large models beyond a few billion parameters there is an
              expectation to utilize systems with large amounts of compute and
              memory.
            </p>
            <p>
          ...
          <div>
            ...
            <p>
              ...
              when citing models. Our recommended citation method is as follows.
            </p>
