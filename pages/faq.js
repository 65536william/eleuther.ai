  ...
  return (
    <Layout>
      <div>
        ...
        <p>
          One day, <a href="https://github.com/ConnorJL">Connor Leahy</a> posted
          in the TPU Podcast Discord:
        </p>
        <DiscordMessage
          date="2020-07-02"
          role="regular"
        ...
        <p>
          In Ancient Greek,{" "}
          <a href="https://en.wikipedia.org/wiki/Eleutheria">eleutheria</a> is a
          word for "liberty", and was used as a proper noun as a personification
          of the concept. This same personage became{" "}
        ...
        <p>
          Join our <a href="https://discord.gg/zBGx3azzUn">Discord</a> or check
          us out on <a href="https://github.com/EleutherAI">GitHub</a>! We're an
          open community, so you are free to contribute as you wish. However, we
          expect newcomers either to be fairly knowledgeable or to sit on the
          sidelines until they understand the internal structure and culture of
          our operations. If you are interested, check out our page on{" "}
          <Link href="/get-involved">getting involved</Link>.
        </p>
        <h3>Are there any other ways to support EleutherAI?</h3>
        <p>
          Yes. If you or someone you know has access to large quantities of CPU,
          GPU, or TPU resources, send a message to Sid Black{" "}
          <DiscordHighlight bright>@Sid</DiscordHighlight> on{" "}
          <a href="https://discord.gg/zBGx3azzUn">Discord</a> with more details.
        </p>
        ...
        <p>
          <a href="https://discord.gg/zBGx3azzUn">Discord</a> is the best place
          for that. Our founding members appear in purple and our core
        ...
        <p>
          ...
          <DiscordHighlight>#communities</DiscordHighlight> channel.
        </p>
        <h2>GPT-Neo and GPT-NeoX</h2>
        <h3>What are GPT-Neo and GPT-NeoX?</h3>
        <p>
          <a href="https://github.com/EleutherAI/gpt-neo">GPT-Neo</a> and{" "}
          <a href="https://github.com/EleutherAI/gpt-neox">GPT-NeoX</a> are our
          codebases for training massive language models, for which we plan to
          release under open licenses. The models themselves are referred to by
          their size (in millions or billions of parameters).
        </p>
        <h3>
          How big is the largest publically available model you have trained?
        </h3>
        <p>
          On June 8th, 2021 we released a 6 billion parameter model trained upon
          the Pile, GPT-J-6B.
        </p>
        <h3>
          Are you serious when you say you are going to train a model comparable
          to the biggest GPT-3 (175 billion parameters)?
        </h3>
        <p>
        ...
        <p>
          As a collective of volunteer researchers and engineers who contribute
          in our free time, we are unable to commit to either a timeline or a
          roadmap for future models.
        </p>
        <h3>How are you training such large models?</h3>
        <p>
          For GPT-Neo, we utilize our limited access to preemptible TPUs through
          the{" "}
          ...
          excited by the open nature of the project and is very keen in helping
          us to break the OpenAI-Microsoft monopoly on massive autoregressive
          language models.
        </p>
        ...
        <p>
          Apart from appending the 24th letter of the ISO basic Latin alphabet,
          GPT-NeoX is an entirely separate, in-development codebase based upon
          Megatron-LM and <a href="https://www.deepspeed.ai/">DeepSpeed</a> and
          is designed for GPUs.
        </p>
        <h3>
        ...
        <p>
          ...
          compute resources: It is not realistic for us to use TRC TPUs to train
          models larger than around 20 billion parameters. Although TRC can
          potentially provide enough TPUs to train such large models, the
          compute is unavailable for the time we would need due to the
          pre-empting of instances. Even with a v3-2048, a model between 150 and
          175 billion parameters would require months to train. CoreWeave
          provides us a path to train models at the scales we would like, but we
          need to utilize their GPUs for training instead of TPUs.
        </p>
        <p>
        ...
        <ul>
          <li>
            Mesh TensorFlow handles TPUs and GPUs differently, and code designed
            for use with TPUs has no guarantee to work well on GPUs.
          </li>
          <li>
            It makes sense to build a new codebase to take full advantage of GPU
            hardware---even tiny performance improvements can add up to
        ...
        <p>
          We have considered the possibility of pooling volunteer resources for
          training models, but upon thorough review, we have concluded that such
          approaches are not a viable option today. There are numerous problems
          with current distributed approaches for us:
        </p>
        <ul>
          <li>
        ...
        <p>
          In short, doing volunteer-driven distributed compute well for this use
          case is an unsolved problem. If you have expertise in this area, drop
          us a line and we will be happy to hear you out.
        </p>
        <h3>
          Have you considered more efficient architectures or methods? Have you
          considered distillation?
        </h3>
        <p>
          Our intention is not to perfectly replicate the architecture used by
          GPT-3 but to instead build models comparable to what OpenAI has built.
          We are committed to exploring the entire space of architectures and
          methods, including various linear-scaling attention mechanisms,
          mixture-of-experts, and other designs. However, in our experience,
          these designs are not always well suited to language modeling:
          Attention mechanisms that scale with linear complexity with respect to
          sequence length are often strictly incompatible with the
          autoregressive objective used for text generation; the remaining
          methods have faired poorly in our testing. Engineering is full of
          trade-offs, and silver-bullet research breakthroughs are uncommon
          occurences.{" "}
          <a>
            If and when new methodologies surpass what we have already, we will
        ...
        <p>
          ...
          unknown if distillation is advantageous at these scales, but we intend
          to find out.
        </p>
        ...
        <p>
          ...
          scale for years to come, even on CPU. To run large models beyond a few
          billion parameters there is an expectation to utilize systems with
          large amounts of compute and memory.
        </p>
        <p>
          Smaller models can be run on more pedestrian hardware: 125 million
          parameters take up only 500 Megabytes and should run on a basic laptop
          without a hitch, while 1.3 billion parameters take up 5 Gigabytes and
          should run on capable personal computers without issue.
        </p>
        <p>
          If you are interested in inferencing and fine-tuning models, we highly
          recommend using{" "}
          <a href="https://huggingface.co/transformers/model_doc/gpt_neo.html">
            the implementation in Hugging Face Transformers
          </a>
          , which is often far easier to both install and use than our research
          code. We do not support or maintain the Hugging Face implementation
          beyond{" "}
        ...
        <p>
          GPT-Neo is MIT-licensed, while GPT-NeoX is licensed under Apache 2.0.
          These are the most freely-termed licenses that we can provide for each
          codebase respectively.
        </p>
        <h3>Are the models free software?</h3>
        <p>
          EleutherAI is licensing models under Apache 2.0. If you use our
          models, we would highly appreciate you citing or displaying your usage
          of them.
        </p>
        ...
        <p>
          The Pile is a 825 GiB diverse, open source language modeling data set
        ...
        <p>
          ...
          users may not expect or want their conversations unwittingly added to
          a public dataset like this. Collecting such a dataset would most
          likely also violate{" "}
        ...
        <p>
          ...
          Links to the code for reproducing each component are also available at
          that repo.
        </p>
      </div>
    </Layout>
